...
def record(experiment, target_metric, model, history, n_train, n_val, times):
    ...
    with open(str(experiments_path), 'a', newline='') as csvfile:
        ...
        avi, chi, english, foreign, grayscale, ijhcs, practice, webby = ExperimentRunner.encode_experiment(experiment)
        ...
        experiments_csv.writerow(
            [news, health, gov, games, food, culture, am2022banks, am2022ecommerce, avi, chi, english, foreign,
             grayscale, ijhcs, practice, webby, target_metric, r2, mse, mae, rmse, n_train, n_val, time, epochs])
